                ...
                launch {
                    viewModel.oneTimeEvents.collect { oneTimeEvents ->
                        when (oneTimeEvents) {
                            ...
                            is CompleteProfileEvents.CloudinaryUploadFailedMessageToast -> {
                                Toast.makeText(this@CompleteProfileScreen, oneTimeEvents.message,Toast.LENGTH_SHORT ).show()

                            }
                            is CompleteProfileEvents.FireStoreUpdateFailedMessageToast -> {
                                Toast.makeText(this@CompleteProfileScreen, oneTimeEvents.message, Toast.LENGTH_SHORT).show()

                            }
                            is CompleteProfileEvents.UserNotLoggedInMessageToast -> {
                                Toast.makeText(this@CompleteProfileScreen,oneTimeEvents.message, Toast.LENGTH_SHORT).show()
